...
// reference https://sugim48.hatenadiary.org/entry/20141007/1412679470
bool square_check(vector<int>& x, vector<int>& y) {
	vector<int> v;
	for (int i = 0; i < 4; i++)
		for (int j = i + 1; j < 4; j++) {
...
bool cube_check(vector<int>& x, vector<int>& y, vector<int>& z) {
	vector<int> v;
	for (int i = 0; i < 8; i++)
		for (int j = i + 1; j < 8; j++) {
